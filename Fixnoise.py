...
def get_pulsar_noise(pta , ret): 
	...
	outDir0='/home/sdb/xuexiao/PTAchains/NoiseFixing/FirstRun/'+pta.pulsars[0]
	...
	outDir1='/home/sdb/xuexiao/PTAchains/NoiseFixing/SecondRun/'+pta.pulsars[0]
...
if __name__ == '__main__':
	...
	np.save('noisepars',save1)
	np.save('noisepardict',save2)
