...
if __name__ == '__main__':
	...
	dm_basis = utils.createfourierdesignmatrix_dm(nmodes=80,
							Tspan=None)
	...
	spn = gp_signals.FourierBasisGP(pl, components=80, Tspan=None,
	...
	sampler = PTSampler(ndim,PTA.get_lnlikelihood,PTA.get_lnprior,
				cov = np.diag(np.ones(ndim)*0.25), groups=None, outDir='/home/sdb/xuexiao/M80PTAchains/FixNoiseBayesian/')
