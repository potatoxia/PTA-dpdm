...
def get_pulsar_noise(pta , ret): 
	...
	outDir0='/home/sdb/xuexiao/M80PTAchains/NoiseFixing/FirstRun/'+pta.pulsars[0]
	...
	outDir1='/home/sdb/xuexiao/M80PTAchains/NoiseFixing/SecondRun/'+pta.pulsars[0]
...
if __name__ == '__main__':
	...
	np.save('M80/noisepars',save1)
	np.save('M80/noisepardict',save2)
